...
const HotStandAloneMovie = ({ movies, title = "Top 10 phim bộ hôm nay" }) => {
  ...
  return (
    <div className="mb-10 mt-8 px-2 sm:px-4 md:px-6">
      {/* Title */}
      <h2 className="mb-4 text-base font-bold text-white sm:text-xl md:text-2xl">
        {title}
      </h2>
...
export default HotStandAloneMovie;
